...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.2/2.9.4/freebsd/11.1/riak-2.9.4.txz
```
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.2/2.9.4/freebsd/10.4/riak-2.9.4.txz
```
