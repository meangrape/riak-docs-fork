...
aliases:
  - /riak-docs/riak/2.9.2/ops/mdc/v2/operations
  - /riak-docs/riak/kv/2.9.2/ops/mdc/v2/operations
---
...
Field | Description
:-----|:-----------
`client_stats` | See <a href="http://docs.basho.com/riak/kv/2.9.2/using/reference/multi-datacenter/statistics/#client-statistics">Client Statistics</a>
...
`server_stats` | See <a href="http://docs.basho.com/riak/kv/2.9.2/using/reference/multi-datacenter/statistics/#server-statistics">Server Statistics</a>
...
`fullsync_worker` | The Erlang process ID of the fullsync worker
`bounded_queue` | See the <a href="http://docs.basho.com/riak/kv/2.9.2/using/cluster-operations/v2-multi-datacenter/#bounded-queue">Bounded Queue</a> section above
