...
toc: true
aliases:
  - /riak-docs/riak/2.9.2/ops/running/stats-and-monitoring
  - /riak-docs/riak/kv/2.9.2/ops/running/stats-and-monitoring
---
...
in the [Inspecting a Node]({{<baseurl>}}riak/kv/2.9.2/using/cluster-operations/inspecting-node/#riak-admin-stat) document.
