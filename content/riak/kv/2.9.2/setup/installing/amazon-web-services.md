...
toc: true
aliases:
  - /riak-docs/riak/2.9.2/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak-docs/riak/kv/2.9.2/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak-docs/riak/2.9.2/installing/amazon-web-services/
  - /riak-docs/riak/kv/2.9.2/installing/amazon-web-services/
---
...
sudo yum localinstall -y riak_2.9.2.amzn2x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.2/amazon/2/riak-2.9.2-1.amzn2x86_64.rpm
sudo rpm -i riak_2.9.2.amzn2x86_64.rpm
```
...
sudo yum localinstall -y riak_2.9.2.amzn1x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.2/amazon/2016.09/riak-2.9.2-1.amzn1x86_64.rpm
sudo rpm -i riak_2.9.2.amzn1x86_64.rpm
```
## Next Steps
