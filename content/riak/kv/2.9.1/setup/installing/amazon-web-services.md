...
toc: true
aliases:
  - /riak-docs/riak/2.9.1/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak-docs/riak/kv/2.9.1/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak-docs/riak/2.9.1/installing/amazon-web-services/
  - /riak-docs/riak/kv/2.9.1/installing/amazon-web-services/
---
...
```bash
wget https://files.tiot.jp/riak/kv/2.2/2.9.1/amazon/2/riak-2.9.1-1.amzn2x86_64.rpm
...
```bash
wget https://files.tiot.jp/riak/kv/2.2/2.9.1/amazon/2016.09/riak-2.9.1-1.amzn1x86_64.rpm
