...
toc: true
aliases:
  - /riak-docs/riak/2.9.1/ops/running/recovery/repairing-indexes
  - /riak-docs/riak/kv/2.9.1/ops/running/recovery/repairing-indexes
  - /riak-docs/riak/2.9.1/ops/running/recovery/failed-node
  - /riak-docs/riak/kv/2.9.1/ops/running/recovery/failed-node
  - /riak-docs/riak/2.9.1/ops/running/recovery/repairing-leveldb
  - /riak-docs/riak/kv/2.9.1/ops/running/recovery/repairing-leveldb
  - /riak-docs/riak/2.9.1/ops/running/recovery/repairing-partitions
  - /riak-docs/riak/kv/2.9.1/ops/running/recovery/repairing-partitions
---
