...
status of a node. This data is available by running the [`riak-admin status`]({{<baseurl>}}riak/kv/2.9.1/using/admin/riak-admin/#riak-admin-status) command. That data now
