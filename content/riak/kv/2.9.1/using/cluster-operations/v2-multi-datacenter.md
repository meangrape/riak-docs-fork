...
aliases:
  - /riak-docs/riak/2.9.1/ops/mdc/v2/operations
  - /riak-docs/riak/kv/2.9.1/ops/mdc/v2/operations
---
...
Field | Description
:-----|:-----------
`client_stats` | See <a href="http://docs.basho.com/riak/kv/2.9.1/using/reference/multi-datacenter/statistics/#client-statistics">Client Statistics</a>
...
`server_stats` | See <a href="http://docs.basho.com/riak/kv/2.9.1/using/reference/multi-datacenter/statistics/#server-statistics">Server Statistics</a>
