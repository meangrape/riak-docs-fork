...
`pr` | PR | `0` | The number of primary <a href="https://www.tiot.jp/riak-docs/kv/2.9.1/learn/concepts/vnodes/">vnodes</a> that must respond to a read request
`pw` | PW | `0` | The number of primary <a href="https://www.tiot.jp/riak-docs/kv/2.9.1/learn/concepts/vnodes/">vnodes</a> that must respond to a write request
...
2 of 3 vnodes agree on the value, and those 2 are the first to reach the coordinating node | The value is returned to the client. Read repair will deal with the conflict per the later scenarios, which means that a future read may return a different value or <a href="https://www.tiot.jp/riak-docs/riak/kv/2.9.1/learn/concepts/causal-context/#siblings">siblings</a>
2 conflicting values reach the coordinating node and <a href="https://www.tiot.jp/riak-docs/riak/kv/2.9.1/learn/concepts/causal-context/#vector-clocks">vector clocks</a> allow for resolution | The vector clocks are used to resolve the conflict and return a single value, which is propagated via read repair to the relevant vnodes
