...
toc: true
aliases:
  - /riak-docs/riak/2.9.1/dev/using/data-types
  - /riak-docs/riak/kv/2.9.1/dev/using/data-types
  - /riak-docs/riak/2.9.1/dev/data-modeling/data-types
  - /riak-docs/riak/kv/2.9.1/dev/data-modeling/data-types
---
